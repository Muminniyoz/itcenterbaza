...
export class RegionsComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.regionsService
      ...
      .subscribe((res: HttpResponse<IRegions[]>) => this.paginateRegions(res.body, res.headers));
  }
  ...
  registerChangeInRegions(): void {
    this.eventSubscriber = this.eventManager.subscribe('regionsListModification', () => this.reset());
  }
  ...
  protected paginateRegions(data: IRegions[] | null, headers: HttpHeaders): void {
