...
export class StudentService {
  ...
  protected convertDateFromClient(student: IStudent): IStudent {
    const copy: IStudent = Object.assign({}, student, {
      ...
      registerationDate:
        student.registerationDate && student.registerationDate.isValid() ? student.registerationDate.format(DATE_FORMAT) : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((student: IStudent) => {
        ...
        student.registerationDate = student.registerationDate ? moment(student.registerationDate) : undefined;
      });
    }
    return res;
  }
